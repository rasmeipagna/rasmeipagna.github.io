...
$resultat_article = $mysqli->query("SELECT titre,photo, prix FROM article WHERE categorie='optique'");
...
<section>
	<body>
		<div class="row"><h1 class="bg title_font center">Lunettes de vues</h1></div>
			
	       	
			<?php
			
				$mysqli = new Mysqli("localhost:8889", "root", "root", "helloeyes") or die ("oups : probème de connexion à la BDD !");
