...
<?php } else if (nimbus_get_option('fp-action1-toggle') == '3') {
    ...
    <section id="<?php if (nimbus_get_option('fp-action1-slug')=='') {echo "action1";} else {echo nimbus_get_option('fp-action1-slug');} ?>" class="frontpage-row frontpage-action1 preview parallax_active" data-parallax='scroll' data-image-src='<?php echo get_template_directory_uri(); ?>/images/preview/cup_pencil1.jpg' style='background: transparent;padding:220px 0 200px;background: rgba(0, 0, 0, 0.3);'>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="action1-title h1" data-sr='wait 0.2s, scale up 25%'>Compétences</div>
                    <!-- <div class="action1-sub-title h4" data-sr='wait 0.2s, scale up 25%'>Convince me why I should take this action.</div> -->
                    <div class="action1-link-button" data-sr='wait 0.2s, scale up 25%'><a href="#">Intégration HTML5/CSS3/JS</a></div>
                    <div class="action1-link-button" data-sr='wait 0.2s, scale up 25%'><a href="#">Développement Front End</a></div>
                    <div class="action1-link-button" data-sr='wait 0.2s, scale up 25%'><a href="#">Thèmes & Plugins Wordpress/Prestashop/Drupal</a></div>
                    <div class="action1-link-button" data-sr='wait 0.2s, scale up 25%'><a href="#">SEO - Référencement - Stratégie</a></div>
                </div> 
            </div>    
        </div>    
    </section> 
