...
--
-- Client :  rasmeipaqzloki.mysql.db
-- Généré le :  Ven 04 Mars 2016 à 10:31
...
--
-- Base de données :  `rasmeipaqzloki`
--
...
(4, 'Jesus', '12345', 'Christ', 'Jesus', 'jesus@mail.com', 'm', 'Paradis', 0, '1 rue du paradis', 0),
(7, 'Starman', '12345', 'Bowie', 'David', 'starman@mail.com', 'm', 'Voie Lact&eacute;e', 12345, '1 rue de Mars', 1);
...
(17, '2016-05-01 09:00:00', '2017-12-12 18:00:00', 17, NULL, 250, 1),
...
--
ALTER TABLE `membre`
  MODIFY `id_membre` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
