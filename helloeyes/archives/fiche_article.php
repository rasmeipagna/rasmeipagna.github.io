...
if($_POST)
{
  ...
  $req = "INSERT INTO avis (id_membre, id_article, pseudo, commentaire, date) VALUES ('$id_membre','$id_article','$pseudo','$commentaire', NOW())";
	...
	<body>
		<div class="row">
            ...
            <?php
                  ...
                  $resultat = $mysqli->query("SELECT id_membre, id_article, pseudo, commentaire, date_format(date, '%d/%m/%Y') AS date_fr, date_format(date, '%H:%i:%s') AS heure_fr FROM avis ORDER BY id_avis DESC") or die ($mysqli->error);
                  ...
                  if(utilisateurEstConnecte()){
                        ...
                        echo '<legend><h2>'.$resultat->num_rows.' Avis</h2></legend>';
                              ...
                              echo '<legend><h1>Laisser un avis</h1></legend>';

                              echo '<input class="ligne" type="hidden" name="id_article" id="id_article" value="" /><br />';
